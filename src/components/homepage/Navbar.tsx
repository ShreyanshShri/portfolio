	...
	return (
		...
		>
			...
			<div
				className={
					active
						? "links flex justify-center items-center backdrop-blur-md flex-col md:flex-row w-full md:w-fit transition-all duration-500  absolute left-[-1000px] top-[9vh]" // inactive
						: "links flex justify-between items-center backdrop-blur-md flex-col md:flex-row w-full md:w-fit transition-all duration-500 absolute md:relative left-[0px] top-[9vh] md:top-[0vh]"
				} // active
			>
